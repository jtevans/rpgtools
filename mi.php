...
$minor = intval(get_var("minor"));
$medium = intval(get_var("medium"));
$major = intval(get_var("major"));

start_html("Random Magic Items");
...
function get_magic_items($quantity, $level)
{
  global $datadir;
  global $weapon_type, $weapon_spec;
  print("<ol>\n");
...
if ($minor > 0)
{
  print("<h1 align=\"center\">Minor Magic Items</h1>\n");
  get_magic_items($minor, "minor");
}

if ($medium > 0)
{
  print("<h1 align=\"center\">Medium Magic Items</h1>\n");
  get_magic_items($medium, "medium");
}

if ($major > 0)
{
  print("<h1 align=\"center\">Major Magic Items</h1>\n");
  get_magic_items($major, "major");
} 
